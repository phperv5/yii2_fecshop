        ...
        <div class="pwa-cart-block pwa-shadow order-panel">
            <div class="pwa-cart-product">
                <div class="product-info flex-row">
                    <div class="pic">
                        <img src="<?= Yii::$service->product->image->getResize($product['image'], [100, 100], false) ?>"
                             alt="<?= $product['name'] ?>">
                        <div class="content"><img
                                    src="<?= Yii::$service->product->image->getResize($product['image'], [100, 100], false) ?>"
            ...
            <div class="pwa-result-by-store">
                <div class="flex-row two-cols">
                    ...
                    <div class="heng">
                        <span class="cost checkout-price"><?= $currency_info['symbol']; ?><?= Format::price($product['product_row_price']); ?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="pwa-cart-block pwa-shadow" id="total-result">
        ...
        <div class="pwa-result-by-store">
            ...
            <div class="flex-row two-cols">
                ...
                <div class="heng">
                    <span id="checkout-price-total" class="cost"
                          data-price="0.45"><?= $currency_info['symbol']; ?><?= Format::price($cart_info['grand_total']) ?></span>
                </div>
            </div>
        </div>
            ...
            <div class="flex-row two-cols">
                ...
                <div class="heng">
                    <div class="ms-rc-ripple ms-rc-custom">
                        <input type="submit" id="create-order" class="pwa-btn" value="Checkout&nbsp;"
                               name="placeOrderBtn">
                    </div>
                </div>
            </div>
            ...
            <div class="flex-row two-cols">
                <div class="scene">
                    ...
                    <label for="PayPalECS">
                        ...
                        <img src="http://img.normankeys.com/images/pay/PayPal_mark_60x38.gif" style="width: 50px;" alt="PayPalECS" border="0" align="absmiddle">&nbsp;&nbsp;<b class="px13 verdana">PayPal
                            Express Checkout</b>
                    </label>
                    <div class="blank5px"></div>
                    <div style="display: none;" class="pay_ex_a" id="area_pay_method_exp_1">
                        If you don't have PayPal account, it doesn't matter. You firstly charge your Paypal with you
                        credit card or bank debit card , then also pay via PayPal.<br>
                    ...
                    <div style="display: none;" class="pay_ex_a" id="area_pay_method_exp_2">
                        ...
                        <p>
                            Note:&nbsp;for easy and quick confirmation of your payment, please do not fix the exchange
                            rate of money.
                    ...
                    <div style="display:none" class="pay_ex_a" id="area_pay_method_exp_3">
                        ...
                        <p>Note:for easy and quick confirmation of your payment, please do not fix the exchange rate of
                            money.
                            When you pay it, send the billing full information to company email box
                            <b style="font-size: 18px;">carkeyunlock@gmail.com
                            We will check it soon, and arrange your order as soon as possible.
                        </p>
                    </div>
