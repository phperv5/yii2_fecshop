...
<header class="new-header j-headerWarp bar bar-nav">
    <div class="new-header-inner">
        <div class="new-return j-common-back com-ripple-btn"><i class="common-ic-md ic-return-md"></i></div>
        <div class="new-head-category j-headCategoryBtn com-ripple-btn open-panel" data-panel="#panel-left-menu"><i class="common-ic-md ic-menu-md"></i></div>
