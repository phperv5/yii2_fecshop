...
<div class="main">
    <div class="page_where_l"><a href="/">Home</a> - Forget password</div><div class="page_where_r"><a href="javascript:history.go(-1);" rel="nofollow">&laquo; Go Back</a></div>
        ...
        <form action="<?= Yii::$service->url->getUrl('customer/account/forgotpasswordsubmit'); ?>" method="post" id="form-validate">
            <div class="lr_l account-create">
                <dl class="w700px">
                    ...
                    <dd><input name="editForm[email]" type="text" id="email_address" size="45" maxlength="40" class="input_normal validate-email required-entry" /><span id="txtIDgetPassEmail" class="red_dark"></span></dd>

                    <dt><span class="red_star">*</span>Verification Code: </dt>
                    <dd>
                        <input name="editForm[captcha]" id="numVerify" type="text" maxlength="4" size="10" class="input_normal login-captcha-input required-entry" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
