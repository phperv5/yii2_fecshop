    ...
    <div class="main_scene">
        ...
        <div class="exh_main">
            ...
            <fieldset>
                ...
                <div class="blank5px"></div>
                <div class="fr"><a href="javascript:void(0);" onclick="CheckAddressEdit(293174);return false;"><img src="../images/ico/edit.gif" hspace="3" align="absmiddle" border="0" />Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" onclick="CheckAddressDelete('293174');return false;"><img src="../images/ico/del.gif" hspace="3" align="absmiddle" border="0" />Delete</a></div>

                <b class="red_dark">Serial #2</b><br />
                <b>&nbsp;2323&nbsp;2323</b><br />
                2323<br />
            ...
            <form name="formAddressDelete" method="post" action="addressBook_app.asp">
            ...
            <form name="formAddressBook" onsubmit="return CheckFormSetAddressBook();" action="addressBook_app.asp" method="post">
                ...
                <dl>
                    ...
                    <dd>
                        ...
                        <div class="fl w200px"><input name="addFirstName" id="addFirstName" type="text" size="22" maxlength="30" value="" class="input_normal" onfocus="InputCss(this,'focus');" onblur="CheckVerifyFirstLastName(this,'txtID_addFirstName','First Name');"><span id="txtID_addFirstName" class="red_dark px11"></span></div>
                        <div class="fl w10px"></div>
                        <div class="fl w200px"><input name="addLastName" id="addLastName" type="text" size="22" maxlength="30" value="" class="input_normal" onfocus="InputCss(this,'focus');" onblur="CheckVerifyFirstLastName(this,'txtID_addLastName','Last Name');"><span id="txtID_addLastName" class="red_dark px11"></span></div>
                    </dd>

                    <dt><span class="red_star">*</span>Address Line1:</dt>
                    <dd><input name="addAddressLine1" id="addAddressLine1" type="text" size="70" maxlength="200" value="" class="input_normal" onfocus="InputCss(this,'focus');" onblur="CheckVerify_addAddressLine1(this,'txtID_addAddressLine1');"><span id="txtID_addAddressLine1" class="red_dark px11"></span></dd>

                    <dt>Address Line2:</dt>
                    <dd><input name="addAddressLine2" id="addAddressLine2" type="text" size="70" maxlength="200" value="" class="input_normal" onfocus="InputCss(this,'focus');" onblur="InputCss(this,'');"></dd>

                    <dt><span class="red_star">*</span>City:</dt>
                    <dd><input name="addCity" id="addCity" type="text" size="35" maxlength="200" value="" class="input_normal" onfocus="InputCss(this,'focus');" onblur="CheckVerify_addCity(this,'txtID_addCity');"><span id="txtID_addCity" class="red_dark px11"></span></dd>
                    ...
                    <dd><input name="addPostalCode" id="addPostalCode" type="text" size="35" maxlength="10" value="" class="input_normal" onfocus="InputCss(this,'focus');" onblur="CheckVerify_addPostalCode(this,'txtID_addPostalCode');"><span id="txtID_addPostalCode" class="red_dark px11"></span></dd>

                    <dt><span class="red_star">*</span>Phone Number:</dt>
                    <dd><input name="addTel" id="addTel" type="text" size="35" maxlength="100" value="" class="input_normal" onfocus="InputCss(this,'focus');" onblur="CheckVerify_addTel(this,'txtID_addTel');"><span id="txtID_addTel" class="red_dark px11"></span></dd>
                    ...
                    <dt>&nbsp;</dt>
                    <dd><input name="is_default" type="checkbox" value="1"  /> Set it to my Default Address</dd>
                ...
                <input name="abSetAction" type="hidden" id="abSetAction" value="add" />
