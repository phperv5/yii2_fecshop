    ...
    <div class="ft_ext">
        <div style="background: rgb(250, 250, 250); margin: 0px; padding: 20px; clear: both; border-top-color: rgb(230, 230, 230); border-bottom-color: rgb(220, 220, 220); border-top-width: 2px; border-bottom-width: 1px; border-top-style: solid; border-bottom-style: solid;">
            <div style="width: 25%; float: left;"><strong>Shipment &amp; Payment</strong>
                <ul>
                    <li><a href="support/how-we-ship-the-item-to-you-4072.html" rel="nofollow" target="_blank">Delivery
                            Options </a></li>
                    <li><a href="support/how-about-your-delivery-cost-4166.html" rel="nofollow" target="_blank">Delivery
                            Cost </a></li>
                    <li><a href="support/how-about-track-your-package-4169.html" rel="nofollow" target="_blank">Tracking
                            Your Items </a></li>
                    <li><a href="support/customs-clearance-import-duty-4713.html" rel="nofollow">Customs &amp; Import
                            Tax</a></li>
            ...
            <div style="width: 25%; float: left;"><strong>Return Information</strong>
                ...
                <ul>
                    ...
                    <li><a href="support/products-warranty-4198.html" rel="nofollow" target="_blank">Products
                            Warranty</a></li>
            ...
            <div style="width: 25%; float: left;"><strong>Customer Service</strong>
                ...
                <ul>
                    ...
                    <li><a href="support/forget-your-account-password-4200.html" rel="nofollow" target="_blank">Forget
                            your account password</a></li>
                    <li><a href="info/drop-ship-service/drop-ship-service.html" rel="nofollow" target="_blank">Wholesale
                            Dropship</a></li>
                    <li><a href="support/tips-to-use-uobd2net-4217.html" rel="nofollow" target="_blank">Tips to use
                            UOBDII</a></li>
            ...
            <div style="width: 25%; float: left;">Join Our Community<br/>
                <a href="http://www.facebook.com/uobd2com" rel="nofollow"><img alt="UOBD2 facebook"
                        ...
                        href="http://www.youtube.com/user/myuobd2" rel="nofollow"><img alt="uobd2 youtube"
                                                                                       src="upload/temp/images/youtube.png"
                                                                                       style="border-image:none; border:0px currentColor; height:32px; width:32px"/></a><br/>
                <a href="https://www.linkedin.com/in/uobd2net" rel="nofollow"><img alt="UOBD2 Linkedin"
                                                                                   src="upload/temp/images/linkedin.png"
                                                                                   style="border-image:none; border:0px currentColor; height:32px; width:32px"/></a><a
                        href="http://blog.uobdii.com/" rel="nofollow"><img alt="UOBD2 blog"
                                                                           src="upload/temp/images/blogger.png"
                                                                           style="border-image:none; border:0px currentColor; height:32px; width:32px"/></a><a
                        href="xml/rss_pro.xml" rel="nofollow"><img alt="UOBD2 RSS" src="upload/temp/images/rss.png"
                                                                   style="border-image:none; border:0px currentColor; height:32px; width:32px"/></a><a
                        href="https://pinterest.com/uobd2/" rel="nofollow"><img alt="uobd2 Pinterest"
                                                                                src="upload/temp/images/pinterest.png"
