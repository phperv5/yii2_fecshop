...
<div class="scene" id="ar_os_shippingAddress" style="display:">
    Your shipping address is null, please <a href="<?= Yii::$service->url->getUrl('customer/address/edit'.Yii::$service->url->getUrl('checkout/onepage')) ?>"><b class="px14">Add Your Shipping Address</b></a>.
</div>