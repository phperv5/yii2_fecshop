        ...
        <div class="tabs">
            ...
            <div class="tabsContent" style="height:450px;overflow:auto;">
                            ...
                            <table style="">
                                ...
                                <?php if (is_array($tier_price) && !empty($tier_price)) { ?>
                                    <?php foreach ($tier_price as $one) { ?>
                                        <tr>
                                            <td>
                                                <input class="tier_qty" type="text" value="<?= $one['qty'] ?>"> and
                                                above
                                            </td>
                                            <td>
                                ...
                                <tr>
                                    <td colspan="100" style="text-align:right;">
                                        <a rel="2" style="text-align:right;" href="javascript:void(0)"
                                           class="addProductTierPrice button">
                ...
                <div class="custom_option">
                    ...
                    <div class="custom_option_img_list"
                         style="display:none;border: 1px dashed #888;margin: 15px 0;padding: 8px 0;">
                        <?= $custom_option_img ?>
                    </div>
                    <div style="clear:both"></div>
