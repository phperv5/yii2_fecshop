...
<div class="pageContent"> 
	<form  method="post" action="<?= $saveUrl ?>" enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return iframeCallback(this, dialogAjaxDoneCloseAndReflush);">
