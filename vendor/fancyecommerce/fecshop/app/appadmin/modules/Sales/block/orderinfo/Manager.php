    ...
    public function getTableTbodyHtml($data)
    {
        ...
        foreach ($data as $one) {
            ...
            if ($one['order_status'] == Yii::$service->order->payment_status_processing) {
                $str .= '<a title="发货" target="dialog" class="buttonActive" mask="true" drawable="true" width="1000" height="580" href="' . CUrl::getUrl('sales/orderinfo/track?order_id=') . $one['order_id'] . '" >发货</a>';
            }
